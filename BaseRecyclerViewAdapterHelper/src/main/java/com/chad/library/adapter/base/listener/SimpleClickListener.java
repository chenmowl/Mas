...
public abstract class SimpleClickListener implements RecyclerView.OnItemTouchListener {
    ...
    protected BaseQuickSwipeAdapter baseQuickSwipeAdapter;
    ...
    protected SimpleClickListener() {}
    public SimpleClickListener(Mode mode) {
        this.mode = mode;
    }
    ...
    public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
        ...
        if (recyclerView == null) {
            ...
            if(mode == Mode.Swipe){
                this.baseQuickSwipeAdapter = (BaseQuickSwipeAdapter) recyclerView.getAdapter();
            }
...
//        Log.e(TAG, "onTouchEvent: ");
                ...
                if (childClickViewIds != null && childClickViewIds.size() > 0) {
                    for (Iterator it = childClickViewIds.iterator(); it.hasNext(); ) {
                        ...
                        if (inRangeOfView(childView, e)) {
                            if(mode == Mode.Normal){
                                onItemChildClick(baseQuickAdapter,pressedView, childView, vh.getLayoutPosition() - baseQuickAdapter.getHeaderLayoutCount());
                            }
                            if(mode == Mode.Swipe){
                                onItemChildClick(baseQuickSwipeAdapter, pressedView,childView, vh.getLayoutPosition() - baseQuickSwipeAdapter.getHeaderLayoutCount());
                            }
                    ...
                    if(mode == Mode.Swipe){
                        onItemClick(baseQuickSwipeAdapter, pressedView, vh.getLayoutPosition() - baseQuickSwipeAdapter.getHeaderLayoutCount());
                    }
            ...
            if (mIsPrepressed && mPressedView != null) {
                ...
                if (!isHeaderOrFooterPosition(vh.getLayoutPosition())) {
                    ...
                    if (longClickViewIds != null && longClickViewIds.size() > 0) {
                        for (Iterator it = longClickViewIds.iterator(); it.hasNext(); ) {
                            ...
                            if (inRangeOfView(childView, e)) {
                                ...
                                if(mode == Mode.Swipe){
                                    onItemChildLongClick(baseQuickSwipeAdapter, childView, vh.getLayoutPosition() - baseQuickSwipeAdapter.getHeaderLayoutCount());
                                }
                    ...
                    if (!isChildLongClick){
                        ...
                        if(mode == Mode.Swipe){
                            onItemLongClick(baseQuickSwipeAdapter, mPressedView, vh.getLayoutPosition() - baseQuickSwipeAdapter.getHeaderLayoutCount());
                        }
     ...
     */
    public abstract void onItemClick(RecyclerView.Adapter adapter, View view, int position);
     ...
     */
    public abstract void onItemLongClick(RecyclerView.Adapter adapter, View view, int position);

    public abstract void onItemChildClick(RecyclerView.Adapter adapter, View parent,View view, int position);

    public abstract void onItemChildLongClick(RecyclerView.Adapter adapter, View view, int position);
    ...
    private boolean isHeaderOrFooterPosition(int position) {
        ...
        int type = 0;
        if(mode == Mode.Normal){
            type = baseQuickAdapter.getItemViewType(position);
        }
        if(mode == Mode.Swipe){
            type = baseQuickSwipeAdapter.getItemViewType(position);
        }
