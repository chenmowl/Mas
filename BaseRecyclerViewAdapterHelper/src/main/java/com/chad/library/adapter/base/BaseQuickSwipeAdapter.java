...
import com.chad.library.adapter.base.swipe.implments.SwipeItemMangerImpl;
import com.chad.library.adapter.base.swipe.interfaces.SwipeAdapterInterface;
import com.chad.library.adapter.base.swipe.interfaces.SwipeItemMangerInterface;
 ...
 * date:2016-9-2
 */
public abstract class BaseQuickSwipeAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements SwipeItemMangerInterface, SwipeAdapterInterface {
    ...
    protected static final String TAG = BaseQuickSwipeAdapter.class.getSimpleName();
    ...
    public RequestLoadMoreListener getOnLoadMoreListener() {
     ...
     */
    public BaseQuickSwipeAdapter(int layoutResId, List<T> data) {
    ...
    public BaseQuickSwipeAdapter(List<T> data) {
        this(0, data);
    }

    public BaseQuickSwipeAdapter(View contentView, List<T> data) {
        this(0, data);
    ...
    public void remove(int position) {//View view,
        ...
        notifyRemoved(position + getHeaderLayoutCount());

        closeAllItems();

    }

    private void notifyRemoved(int p){
        notifyItemRemoved(p);
        if(getData().size() == 0){
            updateNoData();
        }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int positions) {
        ...
        mItemManger.bind(holder.itemView, positions);
    }
