...
public class Util {
    ...
    public static int getStatusBarHeight() {
        ...
        try {
            ...
            statusBarHeight = MasApplication.getInstance().getResources().getDimensionPixelSize(x);
    ...
    public static int getScreenWidth() {
        DisplayMetrics dm = MasApplication.getInstance().getResources().getDisplayMetrics();
