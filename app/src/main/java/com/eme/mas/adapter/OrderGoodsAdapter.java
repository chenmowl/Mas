 ...
 */
public class OrderGoodsAdapter extends RecyclerView.Adapter<OrderGoodsAdapter.ViewHolder>  implements View.OnClickListener{
    public List<MyOrderBo.ProductListBean> datas;
    private int resId;
    private boolean showAll;

    public OrderGoodsAdapter(List datas, int resId) {
        this.datas = datas;
        this.resId = resId;
    }
