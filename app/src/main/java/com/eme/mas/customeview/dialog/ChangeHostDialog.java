 ...
 */
public class ChangeHostDialog extends BaseDialog {

    /**
     * 构造函数
     */
    public ChangeHostDialog() {
    }
    ...
    protected void showView(View view) {
        ...
        tv.setText(R.string.title_host_change);

        final EditText editText= (EditText) view.findViewById(R.id.et_host);
        editText.setText(KConfig.getHOST());
