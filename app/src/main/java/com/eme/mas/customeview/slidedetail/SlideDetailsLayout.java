...
public class SlideDetailsLayout extends ViewGroup {
        ...
        switch (aciton) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (canChildScrollVertically((int) yDiff)) {
                    shouldIntercept = false;
                    if (SlideDebug.DEBUG) {
                        Log.d(SlideDebug.TAG, "intercept, child can scroll vertically, do not intercept");
                    }
                } else {
                    ...
                    if (yDiffabs > mTouchSlop && yDiffabs >= xDiffabs
                        ...
                        if (SlideDebug.DEBUG) {
                            Log.d(SlideDebug.TAG, "intercept, intercept events");
                        }
                    }
                }
                break;
    ...
    private void finishTouchEvent() {
        ...
        if (SlideDebug.DEBUG) {
            Log.v(SlideDebug.TAG, "finish, offset: " + offset + ", percent: " + percent + ", yVelocity: " + yVelocity);
        }
