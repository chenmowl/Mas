...
public class FlowGroupView extends ViewGroup {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < lineNums; i++) {
            ...
            Log.e(TAG+"hang", "第" + i + "行 ：" + lineViews.size() + " , " + lineViews);
            Log.e(TAG+"hang", "第" + i + "行， ：" + lineHeight);
            ...
            LogUtil.e("fdsfdafdsa", top + "");
        }
        Log.e(TAG, "onLayout   mAllViews.size() -- > " + mAllViews.size()
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < cCount; i++) {
            ...
            // 需要换行
            LogUtil.e("宽高o", lineWidth + cWidth + "");
            LogUtil.e("宽高oo", lineWidth + cWidth + "");
            LogUtil.e("子view的个数", cCount + "");


            if (lineWidth + cWidth > specWidthSize) {

                LogUtil.e("duoshaoge","jibian");
                ...
                //不需要换行
                lineWidth += cWidth;//
                height1 = Math.max(lineHeight, cheight);// 取最大值

                LogUtil.e("高度不换行", height + "");
        ...
        // 如果 mode 是 MeasureSpec.EXACTLY 时候，则不是 warp_content
        // 用计算来的值，否则则用上级布局分给它的值
        ...
        setMeasuredDimension(
                ...
                specHeighMode == MeasureSpec.EXACTLY ? specHeighSize : height + height1);
    ...
    /**
     * 这个一定要设置，否则会包强转错误 设置它支持 marginLayoutParams
     */
    @Override
